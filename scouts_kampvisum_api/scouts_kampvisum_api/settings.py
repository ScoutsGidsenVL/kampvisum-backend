...
LEADERSHIP_STATUS_IDENTIFIER = env.str("LEADERSHIP_STATUS_IDENTIFIER", "Leiding")
...
RESOURCES_TEMPLATE_CAMP_CHANGED_AFTER_DEADLINE = RESOURCES_MAIL_TEMPLATE_PATH + "camp_changed_after_deadline.html"
...
EMAIL_REGISTRATION_BCC = env.str("EMAIL_REGISTRATION_BCC", "bosaanvragen@scoutsengidsenvlaanderen.be")
...
OIDC_VERIFY_JWT_SIGNATURE = env.bool("OIDC_VERIFY_JWT_SIGNATURE", default=False)
