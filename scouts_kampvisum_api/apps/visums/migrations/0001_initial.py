    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "camp_registration_mail_last_sent",
                ...
                (
                    "state",
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(
                        blank=True,
                        choices=[
                            ...
                            ("REVIEWED_DISAPPROVED", "reviewed_disapproved"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.RequiredCharField(max_length=64),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "check_type",
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.RequiredCharField(max_length=32),
                ),
            ],
            options={
                "ordering": ["check_type"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    scouts_auth.inuits.models.fields.datetype_aware_date_field.DatetypeAwareDateField(
                        blank=True, null=True
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.OptionalIntegerField(
                        blank=True, null=True
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="checks", to="visums.linkedsubcategory"
            ),
        ),
        migrations.AddField(
            model_name="linkedcheck",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "visum",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="category_set", to="visums.campvisum"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            name="category_set",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="categories", to="visums.linkedcategoryset"
            ),
        ),
        migrations.AddField(
            model_name="linkedcategory",
        ...
        migrations.AddField(
            ...
            name="sub_category",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="checks", to="visums.subcategory"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddField(
            ...
            name="camp_year",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="categories", to="camps.campyear"
            ),
        ),
        migrations.AddField(
            model_name="category",
            name="priority",
            field=models.ForeignKey(
                default=None, on_delete=django.db.models.deletion.CASCADE, to="visums.categorypriority"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name="visum",
                to="visums.campvisumengagement",
            ),
        ),
        migrations.AddField(
            model_name="campvisum",
            name="sections",
            field=models.ManyToManyField(to="groups.scoutssection"),
        ),
        migrations.AddField(
            model_name="campvisum",
            name="updated_by",
        ...
        migrations.AddIndex(
            model_name="linkedcategoryset",
            index=models.Index(fields=["visum"], name="visum_idx"),
        ),
        migrations.AddConstraint(
            model_name="linkedcategoryset",
            constraint=models.UniqueConstraint(fields=("visum",), name="unique_visum_for_set"),
        ),
        migrations.AlterUniqueTogether(
            name="check",
        ...
        migrations.AddIndex(
            model_name="campvisum",
            index=models.Index(fields=["group", "year"], name="group_year_idx"),
        ),
    ]
