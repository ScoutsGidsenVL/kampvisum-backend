    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_name', scouts_auth.inuits.models.fields.django_shorthand_model_fields.RequiredCharField(max_length=128)),
                ...
                ('check_state', scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(blank=True, choices=[('EMPTY', 'Empty'), ('UNCHECKED', 'Unchecked'), ('CHECKED', 'Checked'), ('NOT_APPLICABLE', 'Not applicable')], default='UNCHECKED', max_length=32)),
            ...
            options={
                ...
                'permissions': [('view_campvisum_locations', 'User can view all camp locations'), ('view_campvisum_member_data', 'User is allowed to view gdpr-sensitive data of members'), ('view_campvisum_notes', 'User is a DC and can view approval notes'), ('change_campvisum_notes', 'User is a DC and can edit approval notes')],
            },
        ),
        migrations.CreateModel(
