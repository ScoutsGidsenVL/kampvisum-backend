...
from apps.visums.views import CampVisumEngagementViewSet
from apps.visums.views import CampVisumLocationViewSet
from apps.visums.views import CampVisumViewSet
from apps.visums.views import CategoryViewSet
from apps.visums.views import LinkedCategoryViewSet
from apps.visums.views import LinkedCheckViewSet
from apps.visums.views import SubCategoryViewSet
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_simple_check", "patch": "partial_update_simple_check"}),
        name="simple_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_date_check", "patch": "partial_update_date_check"}),
        name="date_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_duration_check", "patch": "partial_update_duration_check"}),
        name="duration_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_location_check", "patch": "partial_update_location_check"}),
        name="location_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_comment_check", "patch": "partial_update_comment_check"}),
        name="comment_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        LinkedCheckViewSet.as_view({"get": "retrieve_number_check", "patch": "partial_update_number_check"}),
        name="number_check",
    )
)
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "partial_update_approval"}),
        name="approval",
    )
)
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "global_update_approval"}),
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "global_update_disapproval"}),
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "partial_update_dc_notes"}),
        name="notes",
    )
)
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "handle_feedback"}),
...
urlpatterns.append(
    path(
        ...
        CampVisumApprovalViewSet.as_view({"patch": "global_handle_feedback"}),
...
urlpatterns.append(
    path(
        ...
        CampVisumViewSet.as_view({"get": "dates_leaders"}),
        name="visums",
    )
)
...
urlpatterns.append(
    path(
        "visums/all",
        CampVisumViewSet.as_view({"get": "list_all"}),
        name="visums",
    )
)
