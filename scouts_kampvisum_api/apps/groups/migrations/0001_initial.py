    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("group", "name", "gender", "age_group"), name="unique_group_name_gender_age_group_for_section"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="groups.scoutsgrouptype"
            ),
        ),
        migrations.AddField(
