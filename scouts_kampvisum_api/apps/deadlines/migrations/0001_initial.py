    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(
                        ...
                        choices=[
                            ("D", "Deadline"),
                            ("C", "LinkedCheck deadline"),
                            ("S", "LinkedSubCategory deadline"),
                        ],
                        default="D",
                        max_length=1,
                    ),
                ...
                (
                    "deadline",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="items", to="deadlines.deadline"
                    ),
                ),
                (
                    "item_check",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="visums.check"
                    ),
                ),
                (
                    "item_flag",
                    models.ForeignKey(
                        ...
                        to="deadlines.deadlineflag",
                    ),
                ),
                (
                    "item_sub_category",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="visums.subcategory"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parent",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="deadline", to="deadlines.deadline"
                    ),
                ),
                (
                    "updated_by",
                ...
                (
                    "visum",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="deadlines", to="visums.campvisum"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parent",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="deadlines.deadlineflag"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="deadline_item",
                        to="deadlines.linkeddeadlineflag",
                    ),
                ),
                (
                    "linked_check",
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, related_name="due_date", to="deadlines.deadline"
            ),
        ),
        migrations.AddField(
            model_name="deadline",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="deadline_set", to="camps.campyear"
            ),
        ),
        migrations.AddField(
            model_name="deadline",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("item_sub_category", None), ("item_check", None)),
        ...
        migrations.AddConstraint(
            model_name="deadlineitem",
            constraint=models.UniqueConstraint(
                condition=models.Q(("item_flag", None), ("item_check", None)),
        ...
        migrations.AddConstraint(
            model_name="deadlineitem",
            constraint=models.UniqueConstraint(
                condition=models.Q(("item_flag", None), ("item_sub_category", None)),
