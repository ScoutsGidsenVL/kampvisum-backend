    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(
                        blank=True,
                        choices=[("F", "Female"), ("I", "Mixed"), ("M", "Male"), ("X", "Other"), ("U", "Unknown")],
                        default="U",
                        max_length=1,
                    ),
                ),
                ...
                (
                    ...
                    scouts_auth.groupadmin.models.fields.group_admin_id_field.OptionalGroupAdminIdField(
                        blank=True, default="", max_length=48, null=True
                    ),
                ),
                (
                    "group_admin_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    scouts_auth.inuits.models.fields.django_shorthand_model_fields.DefaultCharField(
                        blank=True,
                        choices=[("Y", "YES"), ("N", "NO"), ("X", "NOT_APPLICABLE")],
                        default="N",
                        max_length=1,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="visum_participant",
                        to="participants.inuitsparticipant",
                    ),
                ),
                (
                    "updated_by",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("email__isnull", False), models.Q(("email__exact", ""), _negated=True)),
