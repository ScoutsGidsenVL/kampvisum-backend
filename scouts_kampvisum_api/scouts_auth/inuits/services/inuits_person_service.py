...
class InuitsPersonService:
    ...
    def inuits_personal_details_update(
        ...
        personal_details.cell_number = fields.get("cell_number", personal_details.cell_number)
        personal_details.birth_date = fields.get("birth_date", personal_details.birth_date)
    ...
    def inuits_address_details_update(self, *, address_details: InuitsAddress, **fields) -> InuitsAddress:
        ...
        address_details.postal_code = fields.get("postal_code", address_details.postal_code)
